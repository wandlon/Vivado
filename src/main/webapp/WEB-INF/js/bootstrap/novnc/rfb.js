...
(function () {
    ...
    RFB.prototype = {
        ...
        _updateState: function (state, statusMsg) {
            ...
            //console.log(oldstate + "old111111111");
            //console.log(state + "111111111111");
            if (state === oldstate) {
                // Already here, ignore
            ...
            //console.log(oldstate + "old222222222");
            //console.log(state + "2222222222222");
            if (oldstate === 'fatal') {
            ...
            //console.log(oldstate + "old33333333");
            ...
            //console.log(oldstate + "old44444444444");
            ...
            //console.log(oldstate + "old5555555555");
